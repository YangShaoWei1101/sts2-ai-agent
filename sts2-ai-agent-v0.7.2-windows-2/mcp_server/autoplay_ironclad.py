...
TARGET_CHARACTER_ID = os.getenv("STS2_AUTOPLAY_CHARACTER", "IRONCLAD").strip().upper()
...
def parse_args(argv: "list[str] | None"=None) -> "argparse.Namespace":
    ...
    parser.add_argument("--character",
      ...
      help="Target character id for new runs. Default is IRONCLAD; pass RANDOM_CHARACTER to use the game's random-character option.")
